...
export default function Home() {
  ...
  return (
    <>
      <div className="relative w-full bg-background mt-[-104px] pt-[160px] lg:pt-[180px] pb-[180px] lg:pb-[280px] overflow-hidden">
        <img
          src={imgHeroBeans}
          alt="Grãos de Café"
        ...
        >
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            ...
            <div className="w-full sm:max-w-md relative flex items-center group">
              <MagnifyingGlass
                size={24}
                weight="bold"
                className="absolute left-4 text-primary group-focus-within:text-primary/80 transition-colors"
              />
              <input
                type="text"
      ...
      <main className="relative z-20 mx-auto px-4 sm:px-6 lg:px-12 max-w-7xl -mt-[120px] lg:-mt-[200px] pb-24">
        <div className="mb-24">
          {filteredProducts.length > 0 ? (
            ...
            <div className="text-center py-20 bg-card rounded-3xl border border-light border-dashed shadow-sm">
              <p className="text-xl text-secondary/70 font-semibold">
                Nenhum café encontrado para a sua busca.
              </p>
            </div>
          )}
        </div>
        ...
        <section
          id="delivery"
          className="flex flex-col mb-24 scroll-mt-60 mt-32"
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            <div className="flex flex-col gap-4 items-center group">
              <div className="w-24 h-24 rounded-full bg-background flex items-center justify-center mb-2 group-hover:-translate-y-2 transition-transform duration-300 shadow-sm">
                <img
              ...
              <p className="text-secondary/70 font-medium leading-relaxed max-w-[250px]">
                Temos mais de 20 tipos de café para você saborear.
              </p>
            </div>
            <div className="flex flex-col gap-4 items-center group">
              <div className="w-24 h-24 rounded-full bg-background flex items-center justify-center mb-2 group-hover:-translate-y-2 transition-transform duration-300 shadow-sm">
              ...
              <p className="text-secondary/70 font-medium leading-relaxed max-w-[250px]">
                Serviço de entrega rápido, quentinho e 100% seguro.
              </p>
            </div>
            <div className="flex flex-col gap-4 items-center group">
              <div className="w-24 h-24 rounded-full bg-background flex items-center justify-center mb-2 group-hover:-translate-y-2 transition-transform duration-300 shadow-sm">
              ...
              <p className="text-secondary/70 font-medium leading-relaxed max-w-[250px]">
                Relaxe, faça uma pausa e aproveite sua bebida quente.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center space-y-6 text-center md:text-left">
              ...
              <h3 className="font-bold text-xl sm:text-2xl text-secondary/90 leading-snug">
                ...
                <br className="hidden md:block" /> pronto para entrega.
              </h3>
              <p className="text-base sm:text-lg text-secondary/70 leading-relaxed max-w-lg mx-auto md:mx-0">
                Somos uma empresa apaixonada pela torra e distribuição de
                bebidas deliciosas. Nosso principal produto é feito com uma
                receita secreta, cuidadosamente preparada todas as manhãs.
              </p>
            </div>
          </div>
        </div>
